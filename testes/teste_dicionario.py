...
def preparar_grafo(arestas: list[tuple[str, str, int]]) -> GrafoDicionario:
    """
    Cria um grafo do tipo Dicionário de Dicionários com as conexões fornecidas.
    """
    g = GrafoDicionario()
...
def executar_teste(centros: list[CentroDistribuicao], entregas: list[Entrega], arestas: list[tuple[str, str, int]], mostrar_erros: bool=False) -> dict:
    """
    Executa o teste com grafo baseado em Dicionário de Dicionários, medindo tempo e memória.
    """
