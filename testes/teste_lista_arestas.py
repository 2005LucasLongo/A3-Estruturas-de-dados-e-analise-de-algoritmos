...
def preparar_grafo(arestas: list[tuple[str, str, int]]) -> GrafoListaArestas:
    """
    Cria um grafo do tipo Lista de Arestas com as conexões fornecidas.
    """
    g = GrafoListaArestas()
...
def executar_teste(centros: list[CentroDistribuicao], entregas: list[Entrega], arestas: list[tuple[str, str, int]], mostrar_erros: bool=False) -> dict:
    """
    Executa o teste com grafo baseado em Lista de Arestas, medindo tempo e memória.
    """
