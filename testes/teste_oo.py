...
from model.grafoOrientado import GrafoOrientado  # Importando o Grafo Orientado por Objetos
...
def preparar_grafo() -> GrafoOrientado:
    """
    Cria um grafo orientado com as conexões entre centros e destinos, simulando distâncias (em horas).

    Returns:
        Grafo: Objeto grafo orientado com as arestas definidas.
    """
    g = GrafoOrientado()
...
def executar_teste(qtd_entregas: int) -> dict:
    """
    Executa um teste de desempenho com entregas, medindo tempo e uso de memória.
